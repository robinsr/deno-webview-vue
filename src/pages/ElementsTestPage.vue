  ...
  <section id="forms">
    ...
    <form>
      <fieldset id="forms__input">
        ...
        <x-input type="password" minlength="4" maxlength="12" value="abc123">
          <x-icon href="#lock"></x-icon>
        </x-input>
        <p>
          <x-label for="input__webaddress">Web Address</x-label>
          <x-input id="input__webaddress" type="url" placeholder="https://yoursite.com"></x-input>
        </p>
        <p>
          <x-label for="input__emailaddress">Email Address</x-label>
          <x-input id="input__emailaddress" type="email" placeholder="name@email.com"></x-input>
        </p>
        <p>
          <x-label for="input__phone">Phone Number</x-label>
          <x-input id="input__phone" type="tel" placeholder="(999) 999-9999"></x-input>
        </p>
        <p>
          <x-label for="input__search">Search</x-label>
          <x-input id="input__search" type="search" placeholder="Enter Search Term"></x-input>
        </p>
        <p>
          <x-label for="input__text2">Number Input</x-label>
          <x-input id="input__text2" type="number" placeholder="Enter a Number"></x-input>
        </p>
        <p>
          <x-label for="input__file">File Input</x-label>
          <x-input id="input__file" type="file"></x-input>
        </p>
      </fieldset>
      ...
      <fieldset id="forms__html5">
        ...
        <x-slider min="0" max="40" step="5" value="10 25" vertical>
          <x-label value="0">0° C</x-label>
          <x-label value="5">5° C</x-label>
          <x-label value="10">10° C</x-label>
          <x-label value="15">15° C</x-label>
          <x-label value="20">20° C</x-label>
          <x-label value="25">25° C</x-label>
          <x-label value="30">30° C</x-label>
          <x-label value="35">35° C</x-label>
          <x-label value="40">40° C</x-label>
        </x-slider>
        <p>
